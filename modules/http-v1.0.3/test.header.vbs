VBSLoadRunTime
Set http = VBImport("http.vbs")

WScript.Echo http.ServerFileName("attachment; filename=dssee_setup_x64_v011_signed.exe")
WScript.Echo http.ServerFileName("attachment; filename*=UTF-8''Name%20with%20spaces.txt")
